...
export default function AdminLogin() {
  ...
  const handleLogin = (e: React.FormEvent) => {
    e.preventDefault();
    setLoading(true);
    // Simulation: In a real app, this would hit a secure server action with JWT
    ...
    <div className="min-h-screen flex items-center justify-center p-4 bg-[#0a0a0a]">
      ...
      <Card className="w-full max-w-md border-border bg-[#141217]">
        <CardHeader className="text-center">
          ...
          <CardDescription>Enter your secure credentials to manage ExamIQ matrix.</CardDescription>
        </CardHeader>
        <CardContent>
          <form onSubmit={handleLogin} className="space-y-4">
            ...
            <div className="flex items-center gap-2 text-xs text-muted-foreground pt-4 border-t">
              ...
              This endpoint is protected by server-side JWT verification.
            </div>
          </form>
        </CardContent>
      </Card>
